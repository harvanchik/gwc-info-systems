    ...
    <main id="main" tabIndex={-1}>
      ...
      <section className="lew-section" id="lew" aria-labelledby="lew-heading"><div className="container lew-grid">
        ...
        <div className="lew-copy"><p className="eyebrow">02 / ABOUT LEW</p><h2 id="lew-heading">Lew Weiner</h2><p className="role">Manager / Owner</p><p className="lead">Lew Weiner has spent his career in enterprise software and financial systems, holding an MBA in Business from Fairleigh Dickinson University.</p><p>He works directly with clients on Sage 100 implementation, so businesses get hands-on expertise instead of a call center.</p>
          <div className="lew-details"><div><h3>Education</h3><p>MBA in Business<br />Fairleigh Dickinson University</p></div><div><h3>Professional affiliation</h3><p>Affiliated with <a className="affiliation-link" href="https://www.technology-integrators.com/" target="_blank" rel="noopener noreferrer" title="Opens in a new tab">Technology Integrators Partners</a></p></div></div>
          <a className="profile-link" href="https://www.linkedin.com/in/lew-weiner-7409a540/" target="_blank" rel="noopener noreferrer" title="Opens in a new tab">View Lew’s LinkedIn profile</a>
        </div>
      </div></section>
