...
export default function Home() {
  return <>
    ...
    <header className="header"><div className="container header-inner">
      ...
      <a className="header-phone" href="tel:+13109203603">{phone} <span aria-hidden="true">↗</span></a>
    </div></header>
    <main id="main">
      <section className="hero"><div className="container hero-inner"><div className="hero-copy">
        ...
        <a className="primary-link" href="#contact">Get in Touch <span aria-hidden="true">↗</span></a>
      ...
      <section className="lew-section" aria-labelledby="lew-heading"><div className="container lew-grid"><div className="lew-identity"><p className="eyebrow">02 / ABOUT LEW</p><h2 id="lew-heading">Lew Weiner</h2><p className="role">Manager / Owner</p><div className="credential"><span>MBA in Business</span><p>Fairleigh Dickinson University</p></div></div><div className="lew-copy"><p className="lead">Lew Weiner has spent his career in enterprise software and financial systems, holding an MBA in Business from Fairleigh Dickinson University.</p><p>He works directly with clients on Sage implementation, budgeting, and bank reconciliation, so businesses get hands-on expertise instead of a call center.</p></div></div></section>
      ...
      <section className="contact-section" id="contact"><div className="container contact-grid"><div><p className="eyebrow">04 / CONTACT</p><h2>Get in Touch</h2><p className="contact-name">GWC Information Systems, LLC</p><address><a href={maps} target="_blank" rel="noreferrer">18375 Ventura Blvd., #801<br />Tarzana, CA 91356-4218 <span aria-hidden="true">↗</span></a></address></div><div className="contact-methods"><a href="tel:+13109203603"><span className="small-label">CALL LEW</span><span className="contact-value">{phone}<span aria-hidden="true">↗</span></span></a><a href={`mailto:${email}`}><span className="small-label">EMAIL US</span><span className="contact-value">{email}<span aria-hidden="true">↗</span></span></a></div></div></section>
    </main>
    <footer><div className="container footer-inner"><span>© 2026 GWC Information Systems, LLC</span><a href="#">Back to top <span aria-hidden="true">↑</span></a></div></footer>
  </>;
}
