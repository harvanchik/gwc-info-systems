...
export default function Home() {
  return <>
    ...
    <main id="main">
      ...
      <section className="lew-section" id="lew" aria-labelledby="lew-heading"><div className="container lew-grid">
        ...
        <div className="lew-copy"><p className="eyebrow">02 / ABOUT LEW</p><h2 id="lew-heading">Lew Weiner</h2><p className="role">Manager / Owner</p><p className="lead">Lew Weiner has spent his career in enterprise software and financial systems, holding an MBA in Business from Fairleigh Dickinson University.</p><p>He works directly with clients on Sage implementation, budgeting, and bank reconciliation, so businesses get hands-on expertise instead of a call center.</p>
          ...
          <a className="profile-link" href="https://www.linkedin.com/in/lew-weiner-7409a540/" target="_blank" rel="noreferrer">View Lew’s LinkedIn profile</a>
        </div>
      </div></section>
    ...
    <footer className="site-footer"><div className="container"><div className="footer-main"><div className="footer-company"><strong>GWC Information Systems, LLC</strong><p>Sage accounting software consulting</p><span>Established 1999 · Tarzana, California</span></div><nav aria-label="Footer navigation"><a href="#about">About GWC</a><a href="#lew">About Lew</a><a href="#services">Services</a><a href="#contact">Contact</a></nav></div><div className="footer-bottom"><span>© 2026 GWC Information Systems, LLC</span><a href="https://www.linkedin.com/in/lew-weiner-7409a540/" target="_blank" rel="noreferrer">Lew on LinkedIn</a></div></div></footer>
    <BackToTop />
  </>;
}
